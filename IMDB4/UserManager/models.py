...
class UserIMDB(models.Model):
    ...
    watch_list = models.ManyToManyField("MovieManager.Movie", related_name='in_watch_list')
    hasProAccount = models.BooleanField(default=False, verbose_name='کاربر ویژه', )
    expireTimeToAccountPro = models.DateField(null=True, verbose_name='زمان باقی مانده تا اتمام اعتبار', )
    viewed_movie = models.ManyToManyField("MovieManager.Movie", verbose_name='فیلم ها دیده شده', related_name='in_viewed_movie')
